...
if(WITH_PYTHON)
  if(WITH_APPLE_CROSSPLATFORM)
    set(_python_framework_dir ${LIBDIR}/python/Python.framework)
    if(EXISTS ${_python_framework_dir}/Python)
      set(PYTHON_LIBRARY ${_python_framework_dir}/Python)
      set(PYTHON_INCLUDE_DIR ${_python_framework_dir}/Headers)
      set(PYTHON_INCLUDE_CONFIG_DIR ${_python_framework_dir}/Headers)
      set(PYTHON_LIBPATH ${LIBDIR}/python/lib)
    endif()
    unset(_python_framework_dir)
  endif()
