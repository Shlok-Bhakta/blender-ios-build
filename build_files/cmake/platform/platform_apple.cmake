...
if(WITH_PYTHON)
  if(WITH_APPLE_CROSSPLATFORM)
    ...
    set(PYTHON_LIBPATH "${CROSSCOMPILE_HOST_LIBDIR}/python/lib" CACHE PATH "Python library path for iOS host tools")
...
if(WITH_PYTHON AND NOT WITH_APPLE_CROSSPLATFORM)
