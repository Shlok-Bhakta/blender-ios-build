...
if(WITH_APPLE_CROSSPLATFORM)
  # ARM NEON asm does not reliably link for Apple cross builds (mirrors external_x264 --disable-asm).
  list(APPEND X265_EXTRA_ARGS -DENABLE_ASSEMBLY=OFF)
  list(APPEND X265_10_EXTRA_ARGS -DENABLE_ASSEMBLY=OFF)
  list(APPEND X265_12_EXTRA_ARGS -DENABLE_ASSEMBLY=OFF)
endif()
