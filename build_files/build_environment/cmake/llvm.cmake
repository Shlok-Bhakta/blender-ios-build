...
if(APPLE AND WITH_APPLE_CROSSPLATFORM)
  set(LLVM_PYTHON3_EXECUTABLE ${CMAKE_DEPS_CROSSCOMPILE_INSTALLDIR}/python/bin/python${PYTHON_SHORT_VERSION})
  set(LLVM_BUNDLE_ARGS -DCMAKE_MACOSX_BUNDLE:BOOL=OFF)
else()
  set(LLVM_PYTHON3_EXECUTABLE ${PYTHON_BINARY})
endif()
...
set(LLVM_EXTRA_ARGS
  ...
  -DPython3_EXECUTABLE=${LLVM_PYTHON3_EXECUTABLE}
  ${LLVM_BUNDLE_ARGS}
  ${LLVM_XML2_ARGS}
)
