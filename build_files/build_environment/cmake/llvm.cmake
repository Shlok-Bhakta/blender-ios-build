...
if(WITH_APPLE_CROSSPLATFORM)
  ...
  set(LLVM_PYTHON_ROOT_DIR ${APPLE_CROSSCOMPILE_HOST_BUILD_DIR}/python)
  set(LLVM_TOOL_COMPILE_ARGS
    -DPython3_ROOT_DIR=${LLVM_PYTHON_ROOT_DIR}
    -DPython3_EXECUTABLE=${LLVM_PYTHON_ROOT_DIR}/bin/python3
    -DLLVM_USE_HOST_TOOLS=ON
    -DLLVM_TOOLS_BINARY_DIR=${APPLE_CROSSCOMPILE_HOST_BUILD_DIR}/llvm/bin
    -DLLVM_NATIVE_TOOL_DIR=${APPLE_CROSSCOMPILE_HOST_BUILD_DIR}/llvm/bin
    -DLLVM_INCLUDE_RUNTIMES=ON
    -DLLVM_TARGETS_TO_BUILD=AArch64$<SEMICOLON>ARM
    -DLLVM_ENABLE_BACKTRACES=Off
    -DLLVM_OPTIMIZED_TABLEGEN=OFF
    -DLLVM_TABLEGEN_EXE:string=${APPLE_CROSSCOMPILE_HOST_BUILD_DIR}/llvm/bin/llvm-tblgen
