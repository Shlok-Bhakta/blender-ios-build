...
if(APPLE AND WITH_APPLE_CROSSPLATFORM)
  ...
  set(OPENVDB_BUILD_PYTHON_MODULE ON)
endif()
...
set(OPENVDB_EXTRA_ARGS
  ...
  -DUSE_NANOVDB=ON
  -DOPENVDB_BUILD_PYTHON_MODULE=${OPENVDB_BUILD_PYTHON_MODULE}
  -DOPENVDB_PYTHON_WRAP_ALL_GRID_TYPES=ON
  -DNANOVDB_BUILD_PYTHON_MODULE=OFF
...
if(APPLE AND WITH_APPLE_CROSSPLATFORM)
  set(OPENVDB_PYTHON_EXECUTABLE
    ${CMAKE_DEPS_CROSSCOMPILE_INSTALLDIR}/python/bin/python${PYTHON_SHORT_VERSION}
  )
  list(APPEND OPENVDB_EXTRA_ARGS
    -DPython_EXECUTABLE=${OPENVDB_PYTHON_EXECUTABLE}
    -DPython3_EXECUTABLE=${OPENVDB_PYTHON_EXECUTABLE}
