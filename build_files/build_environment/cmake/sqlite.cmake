...
-fPIC"
  ...
  if(WITH_APPLE_CROSSPLATFORM)
    string(APPEND SQLITE_CFLAGS " -DSQLITE_NOHAVE_SYSTEM=1")
  endif()
  set(SQLITE_PLATFORM_CFLAGS "${PLATFORM_CFLAGS} ${SQLITE_CFLAGS}")
  set(SQLITE_PLATFORM_LDFLAGS "${PLATFORM_LDFLAGS} ${SQLITE_LDFLAGS}")
  set(SQLITE_CONFIGURE_ENV
    ${SQLITE_CONFIGURE_ENV} &&
    export LDFLAGS=${SQLITE_PLATFORM_LDFLAGS} &&
    export CFLAGS=${SQLITE_PLATFORM_CFLAGS}
  )
  set(SQLITE_CONFIGURATION_ARGS
